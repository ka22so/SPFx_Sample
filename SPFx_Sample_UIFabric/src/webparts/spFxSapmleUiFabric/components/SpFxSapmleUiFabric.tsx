...
import styles from './SpFxSapmleUiFabric.module.scss';
import { ISPFxType } from '../containers/SPFxContainer';
import { escape } from '@microsoft/sp-lodash-subset';

export default class SpFxSapmleUiFabric extends React.Component<ISPFxType, {}> {
  public render(): React.ReactElement<ISPFxType> {
    return (
      <div className={ styles.spFxSapmleUiFabric }>

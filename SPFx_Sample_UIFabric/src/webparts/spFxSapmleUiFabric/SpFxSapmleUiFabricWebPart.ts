...
import * as strings from 'SpFxSapmleUiFabricWebPartStrings';
...
export interface ISpFxSapmleUiFabricWebPartProps {
  description: string;
}

export default class SpFxSapmleUiFabricWebPart extends BaseClientSideWebPart<ISPFxProps> {
